...
function deleteTask(name) {
    ...
    // если бы массив был записан не в константе, а в переменной, то можно было бы использовать метод массива filter для выбора и удаления элемента (filter, в данном случае, заменяет findIndex и splice).
    //
    // list = list.filter(item => item.name !== name)
    //
    // в приведенном выше выражении метод filter ищет указанный в параметрах элемент и возвращает массив без этого элемента ( item.name !== name ). 
}
